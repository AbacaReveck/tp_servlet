...
public class DisplayInfo extends HttpServlet
{
    ...
    {
        this.html.addln("<a href=\"./getinfo\">Edit information</a>");
    }
     ...
     */
    private void printDummyPage()
    {
        this.html.addln("<a href=\"dummy_page.html\">Go to the dummy page</a>");
    }
